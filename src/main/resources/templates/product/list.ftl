            ...
            <div class="container-fluid">
                <div class="row clearfix">
                    ...
                    <tr>
                        ...
                        <td><a href="/sell/seller/product/index?productId=${productInfo.productId}">修改</a></li></td>
                        <td>
                           <#if productInfo.productStatus==0>
                               <a href="/sell/seller/product/off_sale?productId=${productInfo.productId}">下架</a></li>
                           <#elseif productInfo.productStatus==1>
                                <a href="/sell/seller/product/on_sale?productId=${productInfo.productId}">上架</a></li>
                           </#if>
                        </td>
